...
Editorial vector illustration, Storyset-ish: a real scene with people in it,
not a symbol. Two figures, always — this is an app about two people.
...
| Depth | Subtle background shapes — a wash, a soft blob, a suggested wall or horizon. Flat colour, no gradients doing heavy lifting, no drop shadows. |
