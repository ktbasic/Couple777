...
export default function AccountScreen() {
    ...
    return (_jsxs(Screen, { className: s.screen, children: [_jsxs("div", { className: s.top, children: [_jsx(SaveUniverse, {}), _jsx("h1", { className: s.title, children: "Your 777 journey starts here" }), _jsx("p", { className: s.body, children: "Little rituals, lasting connections: making time for what matters." })] }), mode === 'choose' ? (_jsxs("div", { className: s.actions, children: [_jsxs(Button, { variant: "secondary", size: "lg", block: true, disabled: busy, onClick: () => void run(() => signInWithProvider('google', next)), children: [_jsx("span", { className: s.mark, "aria-hidden": true, children: _jsx(GoogleMark, {}) }), "Continue with Google"] }), _jsx(Button, { variant: "accent", size: "lg", block: true, onClick: () => setMode('email-up'), children: "Continue with email" }), _jsx("button", { type: "button", className: s.link, onClick: () => setMode('email-in'), children: "Already have an account? Log in" })] })) : (_jsxs("form", { className: s.form, onSubmit: (e) => {
                    e.preventDefault();
                    void run(async () => {
                        if (mode === 'email-up') {
