...
export default function TalkScreen() {
    ...
    return (_jsxs(Screen, { children: [_jsx(ScreenHeader, { eyebrow: "Talk", title: "The conversations worth having", sub: "Small ones every day, bigger ones when you have the evening for it." }), _jsx(DailyCard, {}), _jsxs(Section, { children: [_jsx(SectionHeader, { title: "Go deeper" }), _jsxs("div", { className: s.rows, children: [_jsxs(Link, { to: "/us/talk/room", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83E\uDE9E" }), _jsxs("div", { className: s.rowMain, children: [_jsx("p", { className: s.rowTitle, children: "Relationship Room" }), _jsxs("p", { className: s.rowBody, children: [ROOM_TOPICS.length, " guided conversations. Answer privately, reveal together, agree on one small thing."] })] }), _jsx("span", { className: s.rowMeta, children: CHEV })] }), _jsxs(Link, { to: "/us/talk/notes", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83D\uDC8C" }), _jsxs("div", { className: s.rowMain, children: [_jsxs("p", { className: s.rowTitle, children: ["Notes to ", partner.name] }), _jsx("p", { className: s.rowBody, children: "For the things that are easier written than said. Send now, or set them to arrive later." })] }), _jsxs("span", { className: s.rowMeta, children: [unread ? _jsx("span", { className: s.badge, children: unread }) : null, CHEV] })] }), _jsxs(Link, { to: "/us/talk/daily", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83C\uDF3F" }), _jsxs("div", { className: s.rowMain, children: [_jsx("p", { className: s.rowTitle, children: "Today's check-in" }), _jsx("p", { className: s.rowBody, children: daily.bothAnswered
