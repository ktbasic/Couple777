...
import { matches, memoryYear, milestones, relationshipStats, ritualViews, dailyStatus, } from '@/lib/selectors';
                                    ...
                                    window.setTimeout(() => {
                                        ...
                                        toast.show({ emoji: '🎉', message: `${partner.name} joined` });
                                                ...
                                                : r.overdue
                                                    ...
                                                    : `Due in ${countdownLabel(now, r.cycle.dueDate).toLowerCase()}` })] }), CHEV] }, r.cycle.id))) })] }), _jsxs(Section, { children: [_jsx(SectionHeader, { title: "Talk together", sub: "Answer privately, reveal together." }), _jsxs("div", { className: s.rows, children: [_jsxs(Link, { to: "/us/talk", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83D\uDCAC" }), "Today\u2019s question", _jsx("span", { className: s.rowValue, children: daily.bothAnswered ? 'Both in' : daily.answeredByMe ? 'Waiting' : 'Unanswered' }), CHEV] }), _jsxs(Link, { to: "/us/talk/room", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83E\uDE9E" }), "Relationship Room", _jsx("span", { className: s.rowValue, children: state.roomSessions.filter((r) => r.completedAt).length }), CHEV] }), _jsxs(Link, { to: "/us/talk/notes", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83D\uDC8C" }), "Notes", _jsx("span", { className: s.rowValue, children: state.notes.length }), CHEV] })] })] }), _jsxs(Section, { children: [_jsx(SectionHeader, { title: "The two of you" }), _jsxs("div", { className: s.rows, children: [_jsxs(Link, { to: "/explore?tier=month", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\u2726" }), "Our matches", _jsx("span", { className: s.rowValue, children: matched.length ? matched.map((m) => m.name).join(', ') : 'None yet' }), CHEV] }), _jsxs(Link, { to: "/memories", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\uD83D\uDCF7" }), "Memory timeline", _jsx("span", { className: s.rowValue, children: stats.memories }), CHEV] }), _jsxs(Link, { to: "/us/settings", className: s.row, children: [_jsx("span", { className: s.rowEmoji, "aria-hidden": true, children: "\u2699\uFE0F" }), "Settings & privacy", CHEV] })] })] }), editing ? (_jsx(AvatarPicker, { person: editing, open: true, onClose: () => setEditingId(null) })) : null] }));
}
