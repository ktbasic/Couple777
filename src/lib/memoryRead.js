 ...
 */
const SELF_STATED = /\b(i|we)('m| am| was| feel| felt| have been| had been| keep|'ve been)?\s*(feeling |felt |been )?\b(sad|hurt|angry|upset|lonely|alone|tired|exhausted|anxious|low|down|awful|numb|empty|invisible|unheard|unwanted|unloved)\b/;
...
export function readTone(text) {
     ...
     */
    if (hard === 0)
        return soft >= 2 ? 'positive' : 'neutral';
    if (soft >= 2)
        return 'mixed';
    return 'difficult';
}
