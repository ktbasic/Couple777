  ...
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden>
      <path
        ...
        d="M20 12.4c0 3.5-3.4 6.3-7.6 6.3-.9 0-1.8-.1-2.6-.4L5 20l1.2-3.1C4.9 15.7 4 14.2 4 12.4 4 8.9 7.6 6 11.9 6S20 8.9 20 12.4Z"
      />
      <circle cx="9" cy="12.3" r="1.05" fill="currentColor" />
      <circle cx="12" cy="12.3" r="1.05" fill="currentColor" />
      <circle cx="15" cy="12.3" r="1.05" fill="currentColor" />
    </svg>
  );
}
...
export function IconHomeSolid() {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" aria-hidden>
      <path
        d="M4.2 10.6 12 4.3l7.8 6.3V19a1.2 1.2 0 0 1-1.2 1.2h-3.9v-5.6H9.3v5.6H5.4A1.2 1.2 0 0 1 4.2 19z"
        fill="currentColor"
      />
    </svg>
  );
