 ...
 * fail.
 *
 * Each idea now carries its own `illustrationId` and `IdeaIllustration` draws
 * the scene for it. Nearby and Big Trips keep their photographs on purpose:
 * those are real places, and a real place wants a picture of itself.
 */
