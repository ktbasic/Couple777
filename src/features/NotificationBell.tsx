...
import { byPriority, dailyStatus, notifications, type AppNotification } from '@/lib/selectors';
...
export function NotificationBell() {
  ...
  const items =
    relationship.length > 0 ? relationship : nudges.sort(byPriority).slice(0, 1);
